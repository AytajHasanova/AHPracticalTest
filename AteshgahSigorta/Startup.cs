...
using DataAccessLayer.DTOs.DTOProfiles;
...
namespace AteshgahSigorta
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutoMapper(typeof(LoanDtoProfile));
            services.AddAutoMapper(typeof(ClientDtoProfile));
            services.AddAutoMapper(typeof(InvoiceDtoProfile));
